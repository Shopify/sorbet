...
// Create a constant named `name` under `parent`. To create non-qualified constants, use `ConstantReadNode`, e.g.
// * ConstantPathNode(loc, nullptr, "Foo") -> `::Foo`
// * ConstantPathNode(loc, ConstantReadNode("Foo"), "Bar") -> `Foo::Bar`
