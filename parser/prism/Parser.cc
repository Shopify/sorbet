...
parser::Parser::ParseResult Parser::run(core::MutableContext &ctx, bool directlyDesugar) {
    auto file = ctx.file;
    ...
    return parser::Parser::ParseResult{move(translatedTree), move(parseResult.commentLocations)};
}
