...
public:
    ...
    static parser::ParseResult parseOnly(std::string_view sourceCode);
    static parser::ParseResult translateOnly(core::MutableContext &ctx, std::string_view sourceCode,
