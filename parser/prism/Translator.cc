...
Translator Translator::enterMethodDef(core::LocOffsets methodLoc, core::NameRef methodName) const {
    ...
    return Translator(*this, resetUniqueCounter, methodLoc, methodName, this->isInAnyBlock, this->isInModule);
}
...
Translator Translator::enterBlockContext() const {
    ...
    return Translator(*this, resetUniqueCounter, this->enclosingMethodLoc, this->enclosingMethodName, isInAnyBlock,
                      this->isInModule);
}
