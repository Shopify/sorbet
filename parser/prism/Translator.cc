...
unique_ptr<parser::Node> Translator::translate(pm_node_t *node, bool preserveConcreteSyntax) {
    ...
    switch (PM_NODE_TYPE(node)) {
        ...
        case PM_RESCUE_MODIFIER_NODE: {
            ...
            // this assumes the rescue keyword is at the start of the entire rescue modifier, which is false
            auto keywordLoc = core::LocOffsets{location.beginPos(), location.beginPos() + 6};
