...
public:
     ...
     */
    static unique_ptr<parser::Node> Array(core::LocOffsets loc, parser::NodeVec elements) {
        return make_unique<parser::Array>(loc, move(elements));
    }
     ...
     */
    static unique_ptr<parser::Node> SorbetPrivateStatic(core::LocOffsets loc) {
     ...
     */
    static unique_ptr<parser::Node> TClassOf(core::LocOffsets loc, unique_ptr<parser::Node> type) {
     ...
     */
    static unique_ptr<parser::Node> TNilable(core::LocOffsets loc, unique_ptr<parser::Node> type) {
    ...
    static unique_ptr<parser::Node> TProc(core::LocOffsets loc, unique_ptr<parser::Hash> args,
                                          unique_ptr<parser::Node> returnType) {
        auto builder = T(loc);
