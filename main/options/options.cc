...
buildOptions(const vector<pipeline::semantic_extension::SemanticExtensionProvider *> &semanticExtensionProviders) {
    ...
    options.add_options("advanced")("enforce-chained-sig-syntax", "Enforce usage of chained sig syntax in signatures");
...
void readOptions(Options &opts,
    ...
    try {
        ...
        opts.enforceChainedSigSyntax = raw["enforce-chained-sig-syntax"].as<bool>();
