...
pm_node_t *runRBSRewritePrism(core::GlobalState &gs, core::FileRef file, pm_node_t *node,
                              const std::vector<core::LocOffsets> &commentLocations, const options::Printers &print,
...
parser::ParseResult runPrismParserPrism(core::GlobalState &gs, core::FileRef file, const options::Printers &print) {
    ...
    parser::ParseResult parseResult;
    {
        ...
        parseResult = parser::Prism::Parser::translateOnly(ctx, prismParseResult.getParser(), rewrittenNode,
