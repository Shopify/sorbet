...
public:
    ...
    ast::ExpressionPtr methodSignature(const ast::MethodDef *methodDef, const rbs_methodtype_t *methodType,
                                       const Signature &signature, const std::vector<Comment> &annotations);
     ...
     */
    ast::ExpressionPtr attrSignature(const ast::Send *send, rbs_node_t *type, const Signature &signature,
